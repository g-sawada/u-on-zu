export const initialSettingValues = {
    ...
    tempTitleFontSize: 20,                 //Y軸のタイトルのフォントサイズ
    ...
    rainTitleFontSize: 20,                 //Y軸のタイトルのフォントサイズ

    xAxisFontSize: 16,                     //X軸目盛りのフォントサイズ
    ...
    tempTitleDx: 0,                        //気温軸ラベルの横方向の位置調整
    tempTitleDy: 0,                        //気温軸ラベルの横方向の位置調整
    rainTitleDx: 0,                        //降水量軸ラベルの横方向の位置調整
    rainTitleDy: 0,                        //降水量軸ラベルの横方向の位置調整
    annualReportDx: 0,                        //降水量軸ラベルの横方向の位置調整
    annualReportDy: 0,                        //降水量軸ラベルの横方向の位置調整
}